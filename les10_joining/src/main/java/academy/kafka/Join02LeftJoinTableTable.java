 ...
 */
public class Join02LeftJoinTableTable {
        static final Random rn = new Random();// helper, remove in production

        public static void main(String[] args) {
                Properties props = new Properties();
                props.put(StreamsConfig.APPLICATION_ID_CONFIG, "leftjoin" + rn.nextInt(10000));
                ...
                KTable<String, PaymentStatus> result = paymentRequestTbl.leftJoin(paymentTbl,
