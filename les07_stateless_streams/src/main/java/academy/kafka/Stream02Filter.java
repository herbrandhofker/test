...
public class Stream02Filter {
    ...
    public static void main(final String[] args) {    
        ...
        KStream<String, Car> cars = builder.stream(Car.topicName,
                Consumed.with(AppSerdes.String(), AppSerdes.Car()));
        cars.filter((kenteken, car) -> car.getMake().equals("Ford")).print(Printed.toSysOut());
