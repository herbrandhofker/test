...
public class PaymentRequest05Extra2 {
  final static String topicName= PaymentRequest05Extra1.topicName;
        ...
        public static void main(String[] args) {
                ...
                KTable<String, Registration> regTbl = builder.table(topicName,
