...
public final class ShowData {
    ...
    enum TOPIC {
        Car, Person, Registration, PaymentRequest, FunctionalException, Day
    }

    public static void main(String[] args) {
        TOPIC tp = TOPIC.PaymentRequest;
        switch (tp) {
            ...
            case PaymentRequest:
                ...
                break;
            case Day:
                KafkaUtils.<Day>consumeEntities(Day.topicName, Day.class, grpName);
            case Registration:
