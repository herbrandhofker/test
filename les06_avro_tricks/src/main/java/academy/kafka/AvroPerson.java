...
public class AvroPerson extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2504445737801806902L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"AvroPerson\",\"namespace\":\"academy.kafka\",\"fields\":[{\"name\":\"bsn\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"},{\"name\":\"bancAccount\",\"type\":\"string\"}]}");
   ...
   */
  public static academy.kafka.AvroPerson.Builder newBuilder() {
    return new academy.kafka.AvroPerson.Builder();
  }
   ...
   * @return A new AvroPerson RecordBuilder
   */
  public static academy.kafka.AvroPerson.Builder newBuilder(academy.kafka.AvroPerson.Builder other) {
    if (other == null) {
      return new academy.kafka.AvroPerson.Builder();
    } else {
      return new academy.kafka.AvroPerson.Builder(other);
    }
  }
   ...
   * @return A new AvroPerson RecordBuilder
   */
  public static academy.kafka.AvroPerson.Builder newBuilder(academy.kafka.AvroPerson other) {
    if (other == null) {
      return new academy.kafka.AvroPerson.Builder();
    } else {
      return new academy.kafka.AvroPerson.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroPerson>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(academy.kafka.AvroPerson.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(academy.kafka.AvroPerson other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.bsn)) {
        this.bsn = data().deepCopy(fields()[0].schema(), other.bsn);
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder setBsn(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder clearBsn() {
      bsn = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder clearLastName() {
      lastName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder setBancAccount(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public academy.kafka.AvroPerson.Builder clearBancAccount() {
      bancAccount = null;
