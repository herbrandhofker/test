...
public class WebsocketService02 {
    ...
    public static void main(final String[] args) {
        ...
        Undertow server = Undertow.builder().addHttpListener(port, "localhost")
                                ...
                                case "data": {
                                    channel.getReceiveSetter().set(new AbstractReceiveListener() {
                                        ...
                                        protected void onFullTextMessage(WebSocketChannel channel,
                                            ...
                                            String msg = message.getData();
                                            channels.forEach((ch) -> {
                                                if (getChatboxTag(ch).equals("data"))
                                                    WebSockets.sendText(msg, ch, null);
                                            });
                                        }
                                    });
                ...
                })).addPrefixPath("/", resource(new ClassPathResourceManager(WebsocketService02.class.getClassLoader()))
